...
save_data = true;
if save_data
    save("library/TiO2_9_pillars/z_real_" + num2str(input.lambda0*1e6) + "um_p=" + num2str(input.period_range*1e9) + "nm_t=" + num2str(input.patterned_layer_t_range*1e9) + "nm_res=" + num2str(res) + ".mat", 'z_real');
    save("library/TiO2_9_pillars/z_imag_" + num2str(input.lambda0*1e6) + "um_p=" + num2str(input.period_range*1e9) + "nm_t=" + num2str(input.patterned_layer_t_range*1e9) + "nm_res=" + num2str(res) + ".mat", 'z_imag');
end
...
saveas(gcf, "figs/TiO2_9_pillars/lamb=" + num2str(input.lambda0*1e6) + "um_p=" + num2str(input.period_range*1e9) + "nm_t=" + num2str(input.patterned_layer_t_range*1e9) + "nm.fig");