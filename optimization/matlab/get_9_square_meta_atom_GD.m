...
diameters = input.diameters;
N_diameter = size(diameters, 1);
debug = input.debug;
...
for i_thickness = 1:N_thickness
   ...
   for i_period = 1:N_period
        ...
        for i = 1:size(diameters, 1)
            this_diameter_1 = diameters(i, 1);
            this_diameter_2 = diameters(i, 2);
            this_diameter_3 = diameters(i, 3);
            this_diameter_4 = diameters(i, 4);
            this_diameter_5 = diameters(i, 5);
            this_diameter_6 = diameters(i, 6);
            this_diameter_7 = diameters(i, 7);
            this_diameter_8 = diameters(i, 8);
            this_diameter_9 = diameters(i, 9);
