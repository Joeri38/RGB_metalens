 function [all_meta_atoms,completed_jobs] = get_4_square_meta_atom_GD(input)
...
for i_thickness = 1:N_thickness
   ...
   for i_period = 1:N_period
        ...
        for i_diameter = 1:N_diameter
            this_diameter_1 = diameter_1_range(i_diameter);
            for i_diameter = 1:length(diameter_2_range)
                this_diameter_2 = diameter_2_range(i_diameter);
                for i_diameter = 1:N_diameter
                    this_diameter_3 = diameter_3_range(i_diameter);
                    for i_diameter = 1:N_diameter
                        this_diameter_4 = diameter_4_range(i_diameter);
                        for i_lambda = 1:N_lambda
                            ...
                            this_n_incident_medium = n_incident_medium_range(i_lambda);
                                    ...
                                    d7 = 0;
                                    d8 = 0;
                                    shape_list = vertcat(shape_list,{'four_squares'});
