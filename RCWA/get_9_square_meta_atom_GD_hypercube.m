 function [all_meta_atoms,completed_jobs] = get_9_square_meta_atom_GD(input)
...
substrate_layer_t = 10e-6; % [m]
superstrate_layer_t = 0e-6; % [m]
transmitted_layer_t = 0e-6; % [m]
diameter_1_range = input.diameter_1_range;
diameter_2_range = input.diameter_2_range;
diameter_3_range = input.diameter_3_range;
diameter_4_range = input.diameter_4_range;
diameter_5_range = input.diameter_5_range;
diameter_6_range = input.diameter_6_range;
diameter_7_range = input.diameter_7_range;
diameter_8_range = input.diameter_8_range;
diameter_9_range = input.diameter_9_range;
N_diameter = length(diameter_1_range);
debug = input.debug;
...
%switch input.multiplex % true, case 1
if debug
...
[Idx1, Idx2, Idx3, Idx4, Idx5, Idx6, Idx7, Idx8, Idx9] = ndgrid(diameter_1_range, diameter_2_range, diameter_3_range, ...
                                                                diameter_4_range, diameter_5_range, diameter_6_range, ...
                                                                diameter_7_range, diameter_8_range, diameter_9_range);

% Flatten the grids into vectors
combinations = [Idx1(:), Idx2(:), Idx3(:), Idx4(:), Idx5(:), Idx6(:), Idx7(:), Idx8(:), Idx9(:)];
...
for i_thickness = 1:N_thickness
   ...
   for i_period = 1:N_period
        ...
        for i = 1:size(combinations, 1)
            this_diameter_1 = combinations(i, 1);
            this_diameter_2 = combinations(i, 2);
            this_diameter_3 = combinations(i, 3);
            this_diameter_4 = combinations(i, 4);
            this_diameter_5 = combinations(i, 5);
            this_diameter_6 = combinations(i, 6);
            this_diameter_7 = combinations(i, 7);
            this_diameter_8 = combinations(i, 8);
            this_diameter_9 = combinations(i, 9);
            for i_lambda = 1:N_lambda
                            ...
                            this_n_incident_medium = n_incident_medium_range(i_lambda);
                                    ...
                                    d8 = this_diameter_8;
                                    d9 = this_diameter_9;
                                    shape_list = vertcat(shape_list,{'nine_squares'});
...
all_jobs = table(shape,d1,d2,d3,d4,d5,d6,d7,d8,d9,...
                lambda,nbackground,...
