...
switch shape
    ...
    case 'nine_squares'
        ...
        d7 = settings.d7*1e6; % [um]
        d8 = settings.d8*1e6; % [um]
        d9 = settings.d9*1e6; % [um]
        offset = settings.period*1e6 / 3;
        textures{3} = {nbackground,...
                        [-offset,offset,...
                            d1,d1,...
                            ninclusion,1],...
...
%         assert(d1 > 0 && d2 > 0,"D1 and D2 must be positive");
    ...
    case 'four_circles'
        ...
        offset = settings.period*1e6 / 4;
        textures{3} = {nbackground,...
                         [pillar_cent_x - offset,pillar_cent_y + offset,...
                             d1,d2,...
                             ninclusion,settings.staircase_N],...
                          [pillar_cent_x + offset,pillar_cent_y + offset,...
                              d3,d4,...
...
if ((strcmp(shape,'hollow_square') && d1 == d2 && d3 == d4) || ...
    ...
    (strcmp(shape,'four_squares') && d2==d3 && d1==d4) || ...
